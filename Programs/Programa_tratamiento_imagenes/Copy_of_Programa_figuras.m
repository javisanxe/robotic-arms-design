%FUNCION CREACION DE TRAYECTORIAS IRREGULARES RECONOCIDAS POR IMAGEN

PASOS 
1.-Tratamiento de imagen para obtener la trayectoria pixeles blancos

¿Como va a ser la imagen que reciba?

2.-Paso de trayectoria en pixeles a coordenadas en el espacio cartesiano:

-Ajuste de trayectoria a Rmax,Rmin si trayectorias ''circulares''
-Si trayectoria cualquiera no tiene porque ser circular cerrada),
comprobar que se encuentra dentro del espacio de trabajo posible
...
V(:,:,i)=transl([R*cos(Angulo*i) R*sin(Angulo*i) 0]);
