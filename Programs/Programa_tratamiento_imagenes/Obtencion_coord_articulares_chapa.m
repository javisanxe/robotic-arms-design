...
puntos=350; %Puntos que queremos para muestra representativa 
...
% t = [0,Treposo:delta:Tfigura+Treposo,Ttotal]'; %Tiempos de las posiciones de la trayectoria 
 ...
 t = [0,linspace(Treposo,Tfigura+Treposo,puntos+6+18),Ttotal]'; %Para chapa 
...
qa(2:50,1)=qa(2:50,1)-2*pi;
qa(55:66,1)=qa(55:66,1)-2*pi;
